...
namespace DPC.Controllers
{
    public class TraineesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TraineeId,FirstName,LastName,MiddleName,PhoneNumber,Deanery,Parish,Pathway,DateAdded")] Trainee trainee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TraineeId,FirstName,LastName,MiddleName,PhoneNumber,Deanery,Parish,Pathway,DateAdded")] Trainee trainee)
        {
